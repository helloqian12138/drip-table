...
import { indexValue, parseNumber } from '@/utils/operator';
...
import { type RcTableRecordType, columnRenderGenerator } from './column-render-generator';
...
>(
  ...
  const column: TableColumnType<RcTableRecordType<RecordType>> = {
    ...
    className: classNames({
      ...
      [`${prefixCls}-cell--checked`]: columnSchema.key === extraProps.checkedColumnKey,
    }),
  ...
  const rcTableColumnsRAW = React.useMemo(
    (): TableColumnsType<RcTableRecordType<RecordType>> => {
      const extraProps: DripTableColumnRenderOptions<RecordType, ExtraOptions>['extraProps'] = {
        ...
        ext: tableProps.ext,
        checkedColumnKey: tableProps.checkedColumnKey,
